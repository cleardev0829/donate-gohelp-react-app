...
Icons.bold = ReactDOMServer.renderToString(
  <span class="iconify" data-icon="bx:bold" style={{ width: 18, height: 18 }} />
);
...
Icons.link = ReactDOMServer.renderToString(
  <span class="iconify" data-icon="bx:link" style={{ width: 18, height: 18 }} />
);
...
Icons.video = ReactDOMServer.renderToString(
  <span
    class="iconify"
    data-icon="dashicons:editor-video"
    style={{ width: 18, height: 18 }}
  />
);
